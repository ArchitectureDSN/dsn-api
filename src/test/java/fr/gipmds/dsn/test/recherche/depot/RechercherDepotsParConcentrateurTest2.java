...
class RechercherDepotsParConcentrateurTest2 extends BaseTestClass {
    ...
    void rechercher404PlageManquanteTest() {
        ...
        // plage manquant
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-depots/2.0/");
    ...
    void rechercher422PlageMauvaisDebutTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-depots/2.0/120000/20130101130000");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
    ...
    void rechercher422PlageMauvaiseFinTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-depots/2.0/20130101120000/20130101");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
    ...
    void rechercher429PlageTropGrandeTest() {
        ...
        ResteasyWebTarget target = client
                .target(getServerUrl() + "/lister-depots/2.0/20130101120000/20130101140000");
        Builder builder = target.request();
    ...
    void rechercher200DebutDePlageSeulementTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-depots/2.0/" + date);
        Builder builder = target.request();
    ...
    void rechercher200Test() {
        ...
        ResteasyClient client = new ResteasyClientBuilder()
                .disableTrustManager().build();
        ResteasyWebTarget target = client
                .target(getServerUrl() + "/lister-depots/2.0/20130101120000/20130101121000");
        Builder builder = target.request();
