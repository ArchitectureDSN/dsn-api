...
class RechercherRetoursParDeclarantNetETest2 extends BaseTestClass {
    ...
    void rechercher422PlageMauvaisDebutTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl()
                + "/lister-retours-declarant/2.0/120000/20130101130000/");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
    ...
    void rechercher422PlageMauvaiseFinTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl()
                + "/lister-retours-declarant/2.0/20130101120000/20130101/");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
    ...
    void rechercher200ParDeclarantTest() {
        ...
        ResteasyClient client = new ResteasyClientBuilder()
                .disableTrustManager().build();
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/2.0/20130101120000/20130101130000/");
        Builder builder = target.request();
    ...
    void rechercher429PlageTropGrandeTest() {
        ...
        // plage trop grande
        ResteasyWebTarget target = client.target(getServerUrl()
                + "/lister-retours-declarant/2.0/20130101120000/20130101140000/");
        Builder builder = target.request();
    ...
    void rechercher200DebutDePlageSeulementTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl()
                + "/lister-retours-declarant/2.0/" + date);
        Builder builder = target.request();
    ...
    void rechercher200ParConcentrateurTest() {
        ...
        ResteasyClient client = new ResteasyClientBuilder()
                .disableTrustManager().build();
        ResteasyWebTarget target = client.target(getServerUrl()
                + "/lister-retours-declarant/2.0/20130101120000/20130101130000/");
        Builder builder = target.request();
    ...
    void rechercher401DECLARANTMauvaisTest() {
        ...
        Map<String, String> map = new HashMap<>();
        map.put("concentrateur", TestData.concentrateurInscrit.getFauxJeton());
        map.put("declarant", Base64Utils.encode("Not a valid token"));// valeur  declarant non valide
        String authorization = SecurityUtils.buildAuthorizationHeader(map);
        builder.header("Authorization", authorization);
