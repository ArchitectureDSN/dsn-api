...
@DisplayName("Rechercher Retours Par Declarant Net E Test")
class RechercherRetoursParDeclarantNetETest extends BaseTestClass {
    ...
    void rechercher404PasDePlageTest() {
        ...
        // plage manquant
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/");
    ...
    void rechercher422PlageMauvaisDebutTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/120000/20130101130000");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
        // When
        Response response = invocation.invoke();
    ...
    void rechercher422PlageMauvaiseFinTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/20130101120000/20130101");
        Builder builder = target.request();
        Invocation invocation = builder.buildGet();
        // When
        Response response = invocation.invoke();
    ...
    void rechercher200ParDeclarantTest() {
        // Given
        ResteasyClient client = new ResteasyClientBuilder().disableTrustManager().build();
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/20130101120000/20130101130000");
        Builder builder = target.request();
    ...
    void rechercher429PlageTropGrandeTest() {
        ...
        ResteasyClient client = new ResteasyClientBuilder().disableTrustManager().build();
        // plage trop grande
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/20130101120000/20130101140000");
        Builder builder = target.request();
        Map<String, String> map = new HashMap<>();
        map.put("jeton", TestData.declarantInscrit.getFauxJeton());
        builder.header("Authorization", SecurityUtils.buildAuthorizationHeader(map));
    ...
    void rechercher200DebutDePlageSeulementTest() {
        ...
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/" + date);
        Builder builder = target.request();
        Map<String, String> map = new HashMap<>();
        map.put("jeton", TestData.declarantInscrit.getFauxJeton());
        builder.header("Authorization", SecurityUtils.buildAuthorizationHeader(map));
    ...
    void rechercher401JETONMauvaisTest() {
        ...
        Builder builder = target.request();
        Map<String, String> map = new HashMap<>();
        map.put("jeton", Base64Utils.encode("Not a é valid token"));// valeur jeton non valide
        String authorization = SecurityUtils.buildAuthorizationHeader(map);
        builder.header("Authorization", authorization);
        Invocation invocation = builder.buildGet();
        // When
    ...
    void rechercher401JETONNullTest() {
        // Given
        ResteasyClient client = new ResteasyClientBuilder().disableTrustManager().build();
        ResteasyWebTarget target = client.target(getServerUrl() + "/lister-retours-declarant/1.0/20130101120000");
        Builder builder = target.request();
        Map<String, String> map = new HashMap<>();
